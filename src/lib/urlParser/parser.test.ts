import { parseLanguageUrl, parseTopicUrl } from '.'
...
test('languages with valid url', () => {
  expect(parseLanguageUrl('https://github.com/Afiffudin-au/storezz-server')).toBe(
    'https://api.github.com/repos/Afiffudin-au/storezz-server/languages'
  )
})